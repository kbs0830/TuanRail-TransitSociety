...
def register_template_helpers(app: Flask) -> None:
    ...
    def inject_globals():
        configured = app.config.get("SITE_URL", "")
        site_url = configured.rstrip("/") if configured else request.url_root.rstrip("/")
        return {"static_url": static_versioned_url, "site_url": site_url}
